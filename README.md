...
A IA foi utilizada para auxiliar na compreensão de conceitos da linguagem C, organização da estrutura do código, esclarecimento de dúvidas relacionadas à lógica de programação e apoio na elaboração da documentação do projeto.

Todo o desenvolvimento, implementação, testes, adaptações e validações do código foram realizados pelos integrantes da equipe, sendo a IA utilizada apenas como ferramenta de suporte ao aprendizado e à documentação.